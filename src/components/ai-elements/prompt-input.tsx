...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleClick = useCallback(
    async (event: React.MouseEvent<HTMLDivElement>) => {
      onClick?.(event as React.MouseEvent<HTMLDivElement> & { preventBaseUIHandler: () => void; readonly baseUIHandlerPrevented?: boolean });
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (e: React.MouseEvent<HTMLButtonElement> & { preventBaseUIHandler: () => void; readonly baseUIHandlerPrevented?: boolean }) => {
