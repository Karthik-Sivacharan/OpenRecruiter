export const OUTREACH_STYLE: string = `
...
\`\`\`
Why this is bad: No recruiter intro. "I hope this finds you well", "exciting opportunity", "impressive background", "fast-paced", "innovative", "transforming the landscape", "passionate", "dynamic team". Meeting request CTA. Zero JD details. Pure fluff.
